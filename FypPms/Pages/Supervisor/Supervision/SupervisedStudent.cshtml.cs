...
{
    public class SupervisedStudentModel : PageModel
    {
        private readonly FypPmsContext _context;
        private readonly ILogger<SupervisedStudentModel> _logger;
        ...
        public SupervisedStudentModel(FypPmsContext context, ILogger<SupervisedStudentModel> logger)
        {
            _context = context;
            _logger = logger;
        }
